...
{
  int x; int i;
  fb = (int *)(0x80000000 + 0x200000); // enough for 800x600 SVGA
  font = fonts0;              // use fonts0 for char bit patterns 

  /********* for VGA 640x480 ************************/
  *(volatile unsigned int *)(0x80000000+0x1000001c) = 0x2C77; // LCDCLK
  *(volatile unsigned int *)(0x80000000+0x10120000) = 0x3F1F3F9C;  // time0
  *(volatile unsigned int *)(0x80000000+0x10120004) = 0x090B61DF;  // time1
  *(volatile unsigned int *)(0x80000000+0x10120008) = 0x067F1800;  // time2
  *(volatile unsigned int *)(0x80000000+0x10120010) = (0x200000); // BaseAddress
  *(volatile unsigned int *)(0x80000000+0x10120018) = 0x82B;  //control register
