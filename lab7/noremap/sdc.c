...
int sdc_init()
{
  ...
  base    = (u32)(0x10005000 + 0x80000000); // PL180 base address
...
int getblock(int blk, char *buf)
{
  ...
  */
  printf("waiting for rxdone\n");
    while(rxdone==0);
  printf("done waiting for rxdone\n");
